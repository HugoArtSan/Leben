...
<head>
  <meta charset="utf-8">
  <title>:: MEDISA - Especialidades ::</title>
...
<div class="container col-md-12 panel panel-danger panel-responsive  "> 
  <dt   align="center" class="bg-success">  :: Especialidades ::</dt >
    ...
    <table id="Tdatos" class="table table-hover ">
      <thead>
        <tr>
          ...
          <th id="tablaStatus" onclick="ordenarTabla(2);">Status</th>
          <th id="tablaModifico" onclick="ordenarTabla(2);">Modifico</th>
