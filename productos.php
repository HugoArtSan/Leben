...
<div class="container col-md-12 panel panel-danger panel-responsive  "> 
  <dt   align="center" class="bg-success">  :: Productos ::</dt >
  <div id="clave" class="col-md-2 panel panel-success table-responsive "> 
    <div class="container col-md-12 panel panel-success bg-success">
      ...
      <p>Nombre<input type="text" class="input-sm form-control" id="buscarFolio" placeholder=""></p>
      <p>Linea
  ...
  <div id="datos" class="col-md-12 panel panel-success table-responsive"> 
    
    <table id="Tdatos" class="table table-hover ">
      <thead>
        <tr>
          <th id="tablaFolio" onclick="ordenarTabla(2);">Clave</th>
          <th id="tablaProveedor" onclick="ordenarTabla(2);">Nombre</th>
          <th id="tablaAlmacen" onclick="ordenarTabla(2);">Proveedor</th>
          <th id="tablaReferencia" onclick="ordenarTabla(2);">Linea</th>
          <th id="tablaObservacion" onclick="ordenarTabla(11);">Precio</th>
          <th id="tablaModifico" onclick="ordenarTabla(11);">Modifico</th>
          <th id="tablaFecha" onclick="ordenarTabla(11);">Status</th>
