...
<div class="container col-md-12 panel panel-danger panel-responsive  "> 
  <dt   align="center" class="bg-success">  :: Saldos ::</dt >
    ...
    <table id="Tdatos" class="table table-hover ">
      <thead>
        <tr>
          ...
          <th id="tablaFecha" onclick="ordenarTabla(2);">Fecha</th>
          <th id="tablaCliente" onclick="ordenarTabla(2);">Cliente</th>
          <th id="tablaImporte" onclick="ordenarTabla(2);">Importe</th>
          <th id="tablaPago" onclick="ordenarTabla(11);">Pagado</th>
          <th id="tablaSaldo" onclick="ordenarTabla(11);">Saldo</th>
