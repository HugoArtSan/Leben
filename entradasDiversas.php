...
<head>
  <meta charset="utf-8">
  <title>:: MEDISA - Entradas diversas ::</title>
...
<div class="container col-md-12 panel panel-danger panel-responsive  "> 
  <dt   align="center" class="bg-success">  :: Entradas Diversas ::</dt >
  <div id="clave" class="col-md-2 panel panel-success table-responsive "> 
    <div class="container col-md-12 panel panel-success bg-success">
      ...
      <p>Movimiento
        <select class="input-sm form-control " id="buscarMovimiento" >
          <option>Entrada por ajuste</option>
          <option>Entrada por compra</option>
          <option>Entrada por traspaso</option>
        </select>
      </p>
      ...
      <p>Referencia
        <select class="input-sm form-control " id="buscarReferencia" >
          <option></option>
          ...
          <option>Toma Fisica</option>
          <option>Traspaso</option>
        </select>
      </p>

      <p>Observacion<input type="text" class="input-sm form-control" id="buscarObservacion" placeholder=""></p>
  ...
  <div id="Detallado" class="col-md-12 panel panel-success table-responsive"> 
    ...
    <table id="Tdatos" class="table table-hover ">
      <thead>
        <tr>
          <th id="tablaMov" onclick="ordenarTabla(1);">Mov.</th>
          <th id="tablaFolio" onclick="ordenarTabla(2);">Folio</th>
          <th id="tablaAlmacen" onclick="ordenarTabla(2);">Almacen</th>
          <th id="tablaReferencia" onclick="ordenarTabla(2);">Referencia</th>
          <th id="tablaProducto" onclick="ordenarTabla(11);">Producto</th>
  ...
  <div id="Compacto" class="col-md-12 panel panel-success table-responsive"> 
    ...
    <table id="Tdatos" class="table table-hover ">
      <thead>
        <tr>
          <th id="tablaMovimiento" onclick="ordenarTabla(1);">Movimiento</th>
          <th id="tablaFolio" onclick="ordenarTabla(2);">Folio</th>
          <th id="tablaAlmacen" onclick="ordenarTabla(2);">Almacen</th>
          <th id="tablaReferencia" onclick="ordenarTabla(2);">Referencia</th>
          <th id="tablaObservacion" onclick="ordenarTabla(11);">Observacion</th>
          <th id="tablaFecha" onclick="ordenarTabla(11);">Fecha</th>
          <th id="tablaHora" onclick="ordenarTabla(11);">Hora</th>
          <th id="tablaModifico" onclick="ordenarTabla(11);">Modifico</th>
