...
class Guardador
{
   ...
   public function permisos($nombre, $direccion, $email, $asunto, $estado, $supervisor, $bitacora) {
...
echo json_encode($G->permisos($nombre, $direccion, $email, $asunto, $estado, $supervisor, $bitacora));
