...
<head>
  <meta charset="utf-8">
  <title>:: MEDISA - Toma Fisica ::</title>
...
<div class="container col-md-12 panel panel-danger panel-responsive  "> 
  <dt   align="center" class="bg-success">  :: Toma Fisica ::</dt >
  <div id="clave" class="col-md-2 panel panel-success table-responsive "> 
    ...
    <div class="container col-md-12 panel panel-success bg-success">      
      ...
      <select class="input form-control "  name="lineas" id="lineas" multiple="multiple" size="10" readonly="">
        <option value="IBE">INSUMOS BEBIDAS</option>
        <option value="ICO">INSUMOS COCINA</option>
      </select>

      <label><input id="permiso1" type="checkbox" value="">Todas</label>

     

      <button id="butt_buscar" onclick="buscar(1);" class="btn btn-info center-block" type="button">
      <span class="glyphicon glyphicon-search "></span> Aceptar</button>
  ...
  <div id="a" class="col-md-8 panel panel-info ">
  
  <div id="tomaFisica" class="col-md-12 panel panel-success table-responsive"> 
    
    <table id="Tdatos" class="table table-hover ">
      <thead>
        <tr>
          
          <th id="tablaClave" onclick="ordenarTabla(2);">Clave </th>
          <th id="tablaNombre" onclick="ordenarTabla(2);">Nombre </th>
          <th id="tablaMed" onclick="ordenarTabla(2);">Med. </th>
          <th id="tablaCantidad" onclick="ordenarTabla(11);">Cantidad </th>
  ...
  <div id="clave" class="col-md-2 panel panel-success table-responsive "> 
    <div id="botones" class="col-md-12">
      <button  id="Limpiar" onclick="Limpiar();" class="btn btn-success btn-block" type="button">
      <span class="glyphicon glyphicon-plus-sign"></span> Limpiar</button>
      <button id="Guardar" onclick="Guardar();" class="btn btn-success btn-block" type="button">
      <span class="glyphicon glyphicon-print"></span> Guardar</button>
      <button id="Diferencias" onclick="Diferencias();" class="btn btn-success btn-block" type="button">
      <span class="glyphicon glyphicon-th"></span> Diferencias</button>
      <button id="Plantilla" onclick="Plantilla();" class="btn btn-success btn-block" type="button">
      <span class="glyphicon glyphicon-th"></span> Plantilla</button>
      <button id="Aplicar" onclick="Aplicar();" class="btn btn-success btn-block" type="button">
      <span class="glyphicon glyphicon-th"></span> Aplicar</button>
    </div>
  </div>
