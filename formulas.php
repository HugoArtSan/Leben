...
<div class="container col-md-12 panel panel-danger panel-responsive  "> 
  <dt   align="center" class="bg-success">  :: Formulas ::</dt >
  <div id="clave" class="col-md-2 panel panel-success table-responsive "> 
    <div class="container col-md-12 panel panel-success bg-success">
      ...
      <p>Producto<input type="text" class="input-sm form-control" id="buscarFolio" placeholder=""></p>
  ...
  <div id="formulas" class="col-md-12 panel panel-success table-responsive"> 
