...
<div id="buscarUsuarios" class="col-md-2 panel panel-success ">
  ...
  <p>Usuario</p>
  <p align="center">
  <input type="text" class="form-control" id="buscarNombre" placeholder="BuscarNombre">

  <p>Nombre</p>
  <p align="center">
  <input type="text" class="form-control" id="buscarUsuarios" placeholder="BuscarUsuario">
...
<dt   align="center" class="bg-success">  :: Aparatos::</dt >
  <div id="clave" class="col-md-3 panel panel-success table-responsive "> 
    <div class="container col-md-12 panel panel-success bg-success">
      ...
      <p>Lugar</p>
      <input type="text" class="form-control" id="BuscarLugar" placeholder="BuscarLugar">
...
<div class="container col-md-12 panel panel-danger panel-responsive  "> 
  ...
  <div id="clave" class="col-md-2 panel panel-success table-responsive "> 
    <div class="container col-md-12 panel panel-success bg-success">
      ...
      <p>Nombre</p>
      <p align="center">
      <input type="text" class="form-control" id="buscarAparato" placeholder="Buscar">
        <table class="table table-hover ">
            <tr>
            <p>Status</p>
              <td>
                <select class="form-control " id="buscarStatus" >
                  <option></option>
    ...
    <table id="Tdatos" class="table table-hover ">
      <thead>
        <tr>
          ...
          <th id="tablaNombre" onclick="ordenarTabla(2);">Nombre</th>
          <th id="tablaNivel" onclick="ordenarTabla(3);">Grupo</th>
          <th id="tablaObservaciones" onclick="ordenarTabla(11);">Status</th>
          <th id="tablaModifico" onclick="ordenarTabla(11);">Modifico</th>
         <!-- <th style="visibility:hidden;">Cuantos </th>-->
        </tr>
      </thead>
