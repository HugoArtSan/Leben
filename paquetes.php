...
<div class="container col-md-12 panel panel-danger panel-responsive  "> 
  <dt   align="center" class="bg-success">  :: Paquetes ::</dt >
    ...
    <table id="Tdatos" class="table table-hover ">
      <thead>
        <tr>
          ...
          <th id="tablaDescripcion" onclick="ordenarTabla(2);">Descripcion</th>
          <th id="tablaPrecio" onclick="ordenarTabla(2);">Precio</th>
