...
<head>
  <meta charset="utf-8">
  <title>:: MEDISA - Productos Existencias ::</title>
...
<div class="container col-md-12 panel panel-danger panel-responsive  "> 
  <dt   align="center" class="bg-success">  :: Productos Existencias ::</dt >
  <div id="clave" class="col-md-2 panel panel-success table-responsive "> 
    ...
    <div class="container col-md-12 panel panel-success bg-success">      
      ...
      <label><input id="permiso1" type="checkbox" value="">Nombre</label>
    ...
    <table id="Tdatos" class="table table-hover ">
      <thead>
        <tr>
          ...
          <th id="tablaProducto" onclick="ordenarTabla(2);">Producto </th>
          <th id="tablaExistencia" onclick="ordenarTabla(11);">Existencia </th>
          <th id="tablaCosto" onclick="ordenarTabla(11);">Costo </th>
