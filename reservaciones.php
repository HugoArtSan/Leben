...
<head>
  <meta charset="utf-8">
  <title>:: MEDISA - Reservaciones ::</title>
...
<div class="container col-md-12 panel panel-danger panel-responsive  "> 
  <dt   align="center" class="bg-success">  :: Reservaciones::</dt >
  <div id="clave" class="col-md-2 panel panel-success table-responsive "> 
    <div class="container col-md-12 panel panel-success bg-success">
      ...
      <p>Cliente<input type="text" class="input-sm form-control" id="buscarCliente" placeholder=""></p>
      <p>Servicio<input type="text" class="input-sm form-control" id="buscarServicio" placeholder=""></p>
      ...
      <p>Tomada
        <select class="input-sm form-control " id="buscarTomada" >
          <option>Todos</option>
          <option>Activos</option>
          <option>Inactivos</option>
        </select>
      ...
      <p>Personal
        <select class="input form-control "  name="lineas" id="lineas" multiple="multiple" size="10" readonly="">
          <option value="IBE">--- Todos ---</option>
          <option value="ICO">prueba 1</option>
          <option value="ICO">prueba 2</option>
        </select>
      </p>
