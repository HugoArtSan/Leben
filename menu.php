<div id="menu"  class="container col-md-12 btn-group panel panel-danger panel-responsive  ">    
  <div id="logo" class"btn-group">
    <button type="button" class="btn btn-success dropdown-toggle" id="menuLogo"
  ...
  <div id="menuAdministracion" class="btn-group">
  ...
  <div id="menuInventarios" class="btn-group">
  ...
  <div id="menuReservaciones" class="btn-group">
  ...
  <div id="menuPuntoVenta" class="btn-group">
  ...
  <div id="menuCobranza" class="btn-group">
  ...
  <div id="menuSeguridad" class="btn-group">
